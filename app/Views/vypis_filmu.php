                            ...
                            <?php if($filmy): ?>
                                ...
                                <?php foreach($filmy as $row) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('uprava/'.$row['id_filmu'])?>" class="btn btn-primary btn-info">Upravit</a>
                                            <a href="<?= base_url('smazat/'.$row['id_filmu'])?>" class="btn btn-danger btn-dark">Smazat</a>
                                        </td>
                                        </tr>
                                        <?php endforeach; ?>
                                        <?php endif; ?>
